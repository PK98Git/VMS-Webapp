...
if(count($_POST)>0) {
    mysqli_query($conn,"UPDATE people set name='" . $_POST['name'] . "', nic='" . $_POST['nic'] . "',ContactNumber='" . $_POST['ContactNumber'] . "',email='" . $_POST['email'] . "',dob='" . $_POST['dob'] . "' , address='" . $_POST['address'] . "', gender='" . $_POST['gender'] . "',province='" . $_POST['province'] . "',district='" . $_POST['district'] . "',ds='" . $_POST['ds'] . "' WHERE id='" . $_GET['id'] . "'");
    $message = "Record Modified Successfully"; 
}
    
    $result = mysqli_query($conn,"SELECT * FROM people WHERE id='" . $_GET['id'] . "'");
                                        ...
                                        <div class="col-sm-4 pt-3">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="ds" id="ds" required>
                                                    <option value="<?php echo $row['ds']; ?>"><?php echo $row['ds']; ?></option>
                                                    <option value="Colombo">Colombo</option>
